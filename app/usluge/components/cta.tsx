    ...
    <section className="relative py-24">
      ...
      >
        ...
        <a
          ...
          className="inline-flex items-center gap-2 bg-gradient-to-r from-secondary to-secondary-dark text-white px-6 py-3 rounded-full font-medium hover:shadow-lg transition"
        >
